...
var DEFAULT_CONDITIONS_SET, DEFAULT_URL, NOT_FOUND_ERRORS;
var init_resolve = __esm({
  "node_modules/mlly/lib/resolve.mjs"() {
    DEFAULT_CONDITIONS_SET = new Set(["node", "import"]);
    DEFAULT_URL = pathToFileURL2(process.cwd());
...
var init_local_pkg = __esm({
  "node_modules/local-pkg/index.mjs"() {
    init_lib();
    ({ require: require2 } = createCommonJS(import.meta.url));
  }
});
...
async function loadCollectionFromFS(name) {
  ...
  async function task() {
    ...
    if (jsonPath) {
      const icons = JSON.parse(await fs2.readFile(jsonPath, "utf8"));
      return icons;
    } else {
      return void 0;
    }
...
var _collections, isLegacyExists;
var init_fs = __esm({
  "node_modules/@unocss/preset-icons/dist/fs.mjs"() {
    init_local_pkg();
    _collections = {};
...
// src/index.ts
import { copyFileSync, rmSync, statSync as statSync2 } from "fs";
...
function combineStyleList(stylesheets) {
  return stylesheets.reduce((previousValue, currentValue) => previousValue.extend(currentValue), new StyleSheet()).combine();
}
...
var Magician = class {
  constructor(processor, content, filename, config = {}, userConfig = {}, uno) {
    ...
    this.computedStyleSheet = new StyleSheet();
    this.css = "";
      ...
      return new Promise((resolve3) => {
        if (windiConfig != void 0) {
          if (OPTIONS.configPath) {
            const mTime = statSync2(OPTIONS.configPath).mtimeMs;
