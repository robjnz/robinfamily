(function () {
    ...
    function flatColors$1(colors, head) {
        ...
        for (var _i = 0, _a = Object.entries(colors); _i < _a.length; _i++) {
            ...
            if (typeof value === 'string' || typeof value === 'function') {
                ...
                flatten = __assign$1(__assign$1({}, flatten), flatColors$1(value, head ? head + "-" + key : key));
            }
        }
        return flatten;
    }
    ...
    ***************************************************************************** */
    ...
    function preflight$1(processor, html, includeBase, includeGlobal, includePlugins) {
    ...
    var Processor = /** @class */ (function () {
        ...
        Processor.prototype.preflight = function (html, includeBase, includeGlobal, includePlugins, ignoreProcessed) {
            ...
            return preflight$1(this, html, includeBase, includeGlobal, includePlugins);
        };
    ...
    const { extractInitial = true, preflight = true, mockClasses: enabledMockClasses = false, timing = 'immediate', config = {}, } = window.windicssRuntimeOptions || {};
    ...
    (() => {
        ...
        function init() {
            var _a;
            let styleElement = (_a = window.windicssRuntimeOptions) === null || _a === void 0 ? void 0 : _a.styleElement;
            if (!styleElement) {
                styleElement = document.createElement('style');
                document.head.appendChild(styleElement);
            }
            const processor = new Processor(config);
            const style = new StyleSheet$1();
            console.log('%c[windicss] runtime dom enabled %c\nread more at https://github.com/antfu/windicss-runtime-dom', 'background:#0ea5e9; color:white; padding: 1px 4px; border-radius: 3px;', '');
            let _timer;
            function scheduleUpdate() {
                if (_timer != null)
                    clearTimeout(_timer);
                _timer = setTimeout(updateStyle, 10);
            }
            ...
            function extractAll() {
                document.querySelectorAll('*').forEach((i) => {
                    addClasses(Array.from((i === null || i === void 0 ? void 0 : i.classList) || []));
                    if (preflight)
                        addTags([i.tagName]);
                });
                scheduleUpdate();
