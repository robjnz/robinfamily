import { c as create_ssr_component } from "./app-c975c2d9.js";
var Lost_svelte_svelte_type_style_lang = "";
const css = {
...
const Lost = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
