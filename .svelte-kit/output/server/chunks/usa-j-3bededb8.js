...
var Cemny99_svelte_svelte_type_style_lang = "";
const css$2 = {
...
const Cemny99 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
var Society99_svelte_svelte_type_style_lang = "";
const css$1 = {
...
const Society99 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
var usaJ_svelte_svelte_type_style_lang = "";
const css = {
...
const Usa_j = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
...
<section class="${"one"}"><h1 class="${"ml-8 mt-3 inline-block text-center text-purple-500 text-font-sans text-4xl svelte-wxn5xt"}"><div class="${"h-10 w-14 inline-block svelte-wxn5xt"}"><img src="${"https://res.cloudinary.com/dzhbfdfa5/image/upload/c_scale,h_200,w_300/v1639389123/webp/american-flag.webp"}" alt="${"image of USA flag"}"></div>
	...
	<br>
	<section class="${"one"}"><div class="${"grid sm:flex gap-4 mt-20  svelte-wxn5xt"}">${validate_component(Society99, "Society99").$$render($$result, {}, {}, {})}</div>
...
export { Usa_j as default, prerender };
